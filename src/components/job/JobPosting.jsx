...
const JobPosting=({job,direction,view})=> {
    ...
    <div style={{
        ...
        >
            <Link
                to={`/recruiter-detail/${job?.recruiterProfileId}`}
                style={{
                    width: "max-content",
            ...
            >
                <p style={{fontWeight: 400, fontSize: "16px"}}>
                    {job?.companyName} <ExportOutlined/>
                </p>
            </Link>
        ...
        <div style={{display:view?'none': 'flex', gap: '10px'}}>
            ...
            <Button
                ...
                style={{backgroundColor: '#2058B4', height: "45px", fontSize: "large",color:"#fff", fontWeight: "500"}}
            >
